...
def BatchNorm(data,momentum,name):
    if name not in count_dict:
...
def FullyConnected(data,num_hidden,name):
    if name not in count_dict:
        count_dict[name]=0
...
def get_unrolled_symbol(num_classes, num_layers, image_shape,num_branch=1,num_step=2, conv_workspace=256, **kwargs):
    #print scalar_gate
    """
