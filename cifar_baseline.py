...
if __name__ == "__main__":
    ...
    parser.add_argument('--schedule_off',type=int)
   ...
   # parser.add_argument('--layer-before-fullc', type=str, default='flatten0',
    ...
    parser.set_defaults(image_shape='3,32,32', num_epochs=300,
                        lr=0.1, lr_schedule=[40000,60000,90000],schedule_off=0, wd=0.0001, mom=0.9, batch_size=128,results_prefix='/home/ubuntu/results/',data_dir='/home/ubuntu/data/cifar100',gpu_id=0, num_layers=50,num_branch=1,num_step=1,wide=0,begin_epoch=0
)
    ...
    lr=args.lr
    if args.schedule_off ==1:
        scheduler=None
    else:    
        schedule=args.lr_schedule
        scheduler=mx.lr_scheduler.MultiFactorScheduler(step=schedule,factor=0.1)
    wd=args.wd
    mom=args.mom
    ...
    if args.wide == 1:
        wide = True
        model_prefix='cif100_'+str(num_layers)+'_baseline_v2_'+str(args.wide) 
    else:
        wide = False
        model_prefix='cif100_'+str(num_layers)+'_baseline_v2'
    ...
    sym=net.get_symbol(100, num_layers, image_shape,wide=wide, conv_workspace=256,bottle_neck=True)
    ...
    mod.fit(train,
             ...
             optimizer_params={'learning_rate':lr, 'momentum': mom,'wd':wd, 'lr_scheduler': scheduler },
             num_epoch=num_epoch)
